...
router.get('/', (0, permission_middleware_1.requireRemotePermission)('analytics:view', { application: 'billing',
    allowSuperadmin: true
}), subscription_analytics_controller_1.SubscriptionAnalyticsController.getAnalytics);
// Get analytics for the last 30 days
router.get('/current', (0, permission_middleware_1.requireRemotePermission)('analytics:view', { application: 'billing',
    allowSuperadmin: true
